...
SOURCE_VARIABLE = "SKM_COMPOSE_ENV_FILE"
DEFAULT_IMAGES = {"backend": "skillmind/backend:0.1.0", "web": "skillmind/web:0.1.0"}
IMAGE_VARIABLES = {"backend": "SKM_BACKEND_IMAGE", "web": "SKM_WEB_IMAGE"}
    ...
    def resolve(
        ...
        *,
        ...
        name = (
            ...
            else environment.get("COMPOSE_PROJECT_NAME", "skillmind")
        )
