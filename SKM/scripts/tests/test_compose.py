...
class ComposeContextTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        directory = tempfile.TemporaryDirectory(prefix="skillmind compose test ")
    ...
    def test_default_uses_root_without_reading_dotenv(self) -> None:
        ...
        self.assertEqual(context.project_name, "skillmind")
    ...
    def test_child_environment_fixes_selectors_but_preserves_ordinary_shell_values(self) -> None:
        ...
        environment = {
            ...
            "SKM_COMPOSE_ENV_FILE": "other.env",
            "SKM_BACKEND_IMAGE": "untrusted/backend:latest",
            "SKM_WEB_IMAGE": "untrusted/web:latest",
    ...
    def test_image_pins_are_strict_role_specific_and_override_shell(self) -> None:
        ...
        self.assertEqual(context.child_env["SKM_BACKEND_IMAGE"], pin)
        self.assertEqual(context.child_env["SKM_WEB_IMAGE"], compose.DEFAULT_IMAGES["web"])
        for invalid in (
            {"worker": pin},
            {"backend": "latest"},
            {"web": "sha256:" + "A" * 64},
    ...
    def test_real_fake_child_sees_one_source_and_default_check_stops_failure(self) -> None:
        ...
        program = (
            ...
            "'source':os.environ['SKM_COMPOSE_ENV_FILE']}))"
        )
...
class BackendPackagingSourceTests(unittest.TestCase):
    ...
    def test_development_fixtures_are_excluded_from_the_backend_build_context(self) -> None:
        ...
        patterns = (compose.PROJECT_ROOT / ".dockerignore").read_text(encoding="utf-8").splitlines()
