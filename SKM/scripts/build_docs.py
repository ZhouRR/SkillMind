...
FIRST_PAGES = [
    ...
    "docs/operations/run-performance.md",
]
LEGACY_PAGE_ALIASES = {
    f"SKM/{module}/README.md": {"page": "SKM/README.md", "anchor": module}
...
def validate_examples(documents: list[Document]) -> int:
    ...
    schema = json.loads((ROOT / "SKM/contracts/view-spec/v1alpha1.schema.json").read_text())
