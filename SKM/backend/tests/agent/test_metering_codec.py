...
@pytest.mark.parametrize(
    ...
    [
        "skillmind.db.models",
        "skillmind.runs.budget",
        "skillmind.runs.budget_store",
        "skillmind.runs.budget_execution",
        "skillmind.runs.repository_budgets",
        "skillmind.agent.metering",
    ],
)
def test_invocation_binding_imports_do_not_depend_on_package_order(first_module: str) -> None:
    ...
    subprocess.run(
        [
            ...
            "from skillmind.db.models import RunBudgetObservation\n"
            "from skillmind.runs.budget_store import PostgresRunBudgetStore\n"
            "from skillmind.runs.budget_execution import BudgetInvocationRecorder\n"
