...
from skillmind.api.auth_dependencies import project_not_found_problem
from skillmind.api.problems import PROBLEM_DETAILS_SCHEMA
from skillmind.auth.service import AuthenticatedActor, UnauthorizedSessionError
...
from tests.api.fakes import FakeAuthService, FakeProjectService
...
def test_admin_can_create_list_archive_and_assign_project_member(client: TestClient) -> None:
    ...
    created = client.post(
        ...
        json={
            "key": "quality-team",
            "name": "Quality Team",
            "description": "Synthetic issue analysis",
