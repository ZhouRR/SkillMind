...
from skillmind.api.routes.task_flow import FlowContractResponse, get_task_flow_preview
from skillmind.auth.service import AuthenticatedActor
from skillmind.core.hashing import canonical_json, sha256_hex
from skillmind.projects import ProjectStatus, StoredProject
...
def test_numeric_enum_equivalence_matches_original_and_public_schema(
    ...
    draft: dict[str, Any] = {"contract_version": "skillmind.task-contract-draft/v1"}
    if position == "root":
        draft.update(number)
    elif position == "field":
