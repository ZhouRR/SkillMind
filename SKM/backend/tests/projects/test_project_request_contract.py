...
from skillmind.api.routes.projects import ProjectVersionRequest, UpdateProjectRequest
from skillmind.projects.domain import MAX_PROJECT_VERSION, UpdateProjectCommand
