...
def _minimal_blueprint() -> dict[str, Any]:
    ...
    return {
        ...
        "identity": {
            ...
            "interpreter_version": "skillmind-skill-interpreter/2.1.0",
        },
...
def test_unknown_domain_capability_is_accepted(
    ...
    blueprint["capabilities"] = [
        {"key": "skillmind.development.readiness", "title": "Development Readiness"}
    ]
    blueprint["tasks"][0]["capability"] = "skillmind.development.readiness"

    compiled = validator.validate(blueprint)

    assert compiled.blueprint["capabilities"][0]["key"] == "skillmind.development.readiness"
