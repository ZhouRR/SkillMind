...
from skillmind.storage.memory import InMemoryFileStorage
from skillmind.storage.namespace import (
...
def test_factory_passes_configured_namespace_without_reading_settings_sources(
    ...
    monkeypatch.setattr("skillmind.storage.factory.S3FileStorage", constructor)
...
def test_credential_rotation_does_not_rebind_factory_namespace(
    ...
    monkeypatch.setattr("skillmind.storage.s3.Minio", constructor)
