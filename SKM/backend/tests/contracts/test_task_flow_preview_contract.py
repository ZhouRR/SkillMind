...
from skillmind.api.routes.task_flow import TaskFlowPreviewResponse, _preview_response
from skillmind.core.hashing import canonical_json, sha256_hex
from skillmind.skills.resource_binding import evaluate_blueprint_readiness
from skillmind.skills.service import TaskFlowPreviewResult
from skillmind.skills.task_flow_preview import project_task_flow_preview
...
@pytest.mark.parametrize(
    "field,value",
    [
        ("preview_version", "skillmind.task-flow-preview/v2"),
        ("status", "RUNNING"),
        ("status", "NOT_DECLARED"),
        ...
        ("progress", 80),
        ("flow_version", "skillmind.task-flow/v1"),
        ("nodes", []),
        ("edges", []),
    ],
)
