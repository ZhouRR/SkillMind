...
EXAMPLES = {
    ...
    "examples/database-read-request.v2.json": "tools/database.read/v2/request.schema.json",
    ...
    "examples/mcp-tools-request.v1.json": "tools/mcp.tools/v1/request.schema.json",
    "examples/mcp-query-request.v1.json": "tools/mcp.query/v1/request.schema.json",
    "examples/mcp-call-request.v1.json": "tools/mcp.call/v1/request.schema.json",
    "examples/mcp-tools-response.v1.json": "tools/mcp.tools/v1/response.schema.json",
    "examples/mcp-query-response.v1.json": "tools/mcp.query/v1/response.schema.json",
    "examples/mcp-call-response.v1.json": "tools/mcp.call/v1/response.schema.json",
    "examples/mcp-tools-error.v1.json": "tools/mcp.tools/v1/error.schema.json",
    "examples/mcp-query-error.v1.json": "tools/mcp.query/v1/error.schema.json",
    "examples/mcp-call-error.v1.json": "tools/mcp.call/v1/error.schema.json",
    ...
    "examples/run-detail-metrics.v1.json": "runs/detail/v1.schema.json",
