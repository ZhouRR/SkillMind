...
from skillmind.auth.service import AuthService, InvalidCredentialsError, LoginCsrfError
...
async def test_account_rejection_stops_before_challenge_password_and_database(
    ...
    monkeypatch.setattr("skillmind.auth.service.verify_password", verify)
