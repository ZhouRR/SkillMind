...
from skillmind.db.models import Run, RunAttempt, RunSegment
from skillmind.effects.domain import ChangeProposalDraft
...
from skillmind.runs.interaction import InteractionRequestDraft, parse_interaction_request
...
async def test_wait_keeps_original_checkpoint_and_rechecks_lease_after_artifact_read(
    ...
    monkeypatch.setattr("skillmind.artifacts.repository.ArtifactRepository.verified_refs", verify)
