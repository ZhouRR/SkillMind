...
def create_command(*, ticket_id: str = "ISSUE-1234") -> CreateRunCommand:
...
def test_request_hash_is_stable_for_equivalent_json() -> None:
    ...
    reordered = CreateRunCommand(
        ...
        input_json={"nested": {"a": 1, "b": 2}, "ticket_id": "ISSUE-1234"},
...
def test_request_hash_changes_when_input_changes() -> None:
    ...
    original = create_command(ticket_id="ISSUE-1234")
    changed = CreateRunCommand(
        project_id=original.project_id,
        task_id=original.task_id,
        idempotency_key=original.idempotency_key,
        input_json={"ticket_id": "ISSUE-9999", "nested": {"b": 2, "a": 1}},
