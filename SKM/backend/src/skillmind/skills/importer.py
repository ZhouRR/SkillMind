...
# HTTP の受信境界と静的 parser に同じ上限を渡し、CLI の既定値とは分離する。
HTTP_SKILL_IMPORT_LIMITS = SkillImportLimits(
    max_files=100,
...
class NormalizedSkillPackage:
    """Adapter 差を吸収した skillmind.normalized/v1 package。"""
        ...
        manifest: dict[str, Any] = {
            ...
            "identity": {
                ...
                "interpretation_id": str(
                    uuid5(NAMESPACE_URL, f"skillmind:deterministic:{package.content_hash}")
                ),
