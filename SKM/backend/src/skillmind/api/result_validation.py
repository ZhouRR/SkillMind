...
class ResultReferenceChecksV1Response(TypedDict):
    ...
    version: Literal["skillmind.result-reference-checks/v1"]
...
class ResultReferenceChecksV2Response(TypedDict):
    ...
    version: Literal["skillmind.result-reference-checks/v2"]
    evidence: Literal["RUN_OWNERSHIP"]
    proposals: Literal["RUN_OWNERSHIP_AND_STATE"]
    effects: Literal["PLATFORM_RECORD_MATCH", "NOT_APPLICABLE"]
...
def result_validation_response(
    ...
    try:
        ...
        if checks is not None:
            ...
            if (
                checks["version"] == "skillmind.result-reference-checks/v1"
                        ...
                        "allOf": [{
                            ...
                            "if": {
                                ...
                                "properties": {"reference_checks": {
                                    "required": ["version"],
                                    "properties": {"version": {
                                        "const": "skillmind.result-reference-checks/v2",
                                    }},
                                }},
                            },
                            "then": {
                            ...
                            "if": {
                                ...
                                "properties": {"reference_checks": {
                                    "required": ["version"],
                                    "properties": {"version": {
                                        "const": "skillmind.result-reference-checks/v1",
                                    }},
                                }},
                            },
                            "then": {
