...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+asyncpg://skillmind:skillmind@localhost:5432/skillmind"
    ...
    object_storage_bucket: str = "skillmind"
    object_storage_access_key: str = "skillmind"
    object_storage_secret_key: str = "skillmind"
    ...
    def auth_session_cookie_name(self) -> str:
        ...
        if self.environment == "production":
            return "__Host-skillmind_session"
        return "skillmind_session"
