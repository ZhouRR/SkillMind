...
from skillmind.runs.domain import ClaimedRun, LeaseValidationError, RunStatus, lease_token_hash
...
class RunBudgetRepository(_RunRepositoryBase):
    ...
    async def record_observation(
        ...
        from skillmind.agent.metering import ResultUsageObservation
