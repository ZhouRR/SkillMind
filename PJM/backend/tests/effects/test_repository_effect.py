...
from projectmind.effects.domain import ClaimedEffectExecution, EffectExecutionStatus
from projectmind.effects.forge import PullRequestRef
...
_BRANCH = "projectmind/run-7a1c/fix-null-guard"
...
async def test_svn_branch_mode_commits_under_the_fixed_convention(tmp_path: Path) -> None:
    """svn は `branches/projectmind/` 配下へ copy して commit する (計画 §20 D5)。"""
    ...
    home = tmp_path / "home"
    branch_url = f"file://{tmp_path / 'svnrepo'}/branches/projectmind/run-7a1c/fix-null-guard"
