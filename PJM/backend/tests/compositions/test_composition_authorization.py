...
from projectmind.compositions.domain import ModuleNotFoundError, ModuleSkillInvalidError
...
def prepare(monkeypatch: pytest.MonkeyPatch, operation: Operation) -> CompositionSession:
    ...
    Clock.current = NOW
    monkeypatch.setattr("projectmind.compositions.service.datetime", Clock)
