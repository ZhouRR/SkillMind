...
from projectmind.effects.catalog import EFFECT_CAPABILITIES
from projectmind.effects.domain import ClaimedEffectExecution, EffectEvidenceDraft
from projectmind.effects.redmine import RedmineIssueSnapshot, RedmineIssueUpdateProvider
from projectmind.effects.repository_effect import _result as repository_effect_result
...
async def test_actual_provider_result_and_evidence_writer_match_new_result_gate(
    ...
    if provider == "redmine":
        ...
        result = repository_effect_result(
            claimed, base_revision="original-revision", branch="projectmind/test",
