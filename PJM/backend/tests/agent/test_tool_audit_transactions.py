...
from projectmind.db.models import Evidence, PermissionDecision, RunAttempt, RunSegment, ToolCall
...
class AuditDatabase:
    ...
    def __init__(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("projectmind.agent.evidence.datetime", clock)
