...
def _blueprint() -> dict[str, Any]:
    ...
    return {
        ...
        "identity": {
            ...
            "interpreter_version": "projectmind-skill-interpreter/2.2.0",
        },
...
def _tools() -> tuple[RegisteredTool, ...]:
    ...
    return (
        RegisteredTool(
            ...
            sdk_name="mcp__projectmind__issue_read",
            provider="csv",
            integration_id=None,
...
def _materialized_repository() -> MaterializedResource:
    ...
    return MaterializedResource(
        ...
        manifest_path="input/target_repository/.projectmind/manifest.json",
        index_path="input/target_repository/.projectmind/files.txt",
        history_path="input/target_repository/.projectmind/history.txt",
        revision="b" * 40,
        files=12,
        skipped=2,
    )
...
def test_brief_tells_the_agent_where_materialized_resources_are() -> None:
    ...
    assert placement == {
        "root": "input/target_repository",
        "manifest": "input/target_repository/.projectmind/manifest.json",
        "index": "input/target_repository/.projectmind/files.txt",
        "history": "input/target_repository/.projectmind/history.txt",
        "revision": "b" * 40,
...
def test_prompt_points_the_agent_at_the_materialized_tree_and_skipped_meaning() -> None:
    ...
    assert "input/target_repository/.projectmind/files.txt" in prompt
    assert "input/target_repository/.projectmind/history.txt" in prompt
