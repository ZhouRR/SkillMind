...
from projectmind.agent.metering import AgentInvocation, AgentInvocationMode, ResultUsageObservation
from projectmind.core.hashing import sha256_hex
from projectmind.runs.budget import BudgetStartUncertainError, BudgetUnavailableError
...
def isolated_sdk_environment(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("projectmind.agent.claude.sanitized_agent_environment", lambda _config: {})
