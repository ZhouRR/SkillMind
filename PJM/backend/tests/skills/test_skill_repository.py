...
from projectmind.db.models import ProjectSkillVersion, SkillInterpretation, SkillSource
...
def _command() -> SaveSkillPreviewCommand:
    ...
    return SaveSkillPreviewCommand(
        ...
        preview=SkillPreview(
            ...
            runtime_manifest_draft={"manifest_version": "projectmind/v1alpha1"},
        ),
    )
...
async def test_save_preview_creates_source_and_interpretation() -> None:
    ...
    stored = await SkillRepository(session).save_preview(command)
...
def _model_command(
    ...
    return SaveModelInterpretationCommand(
        ...
        diagnostics=(),
        normalized_package={"package_format": "projectmind.normalized/v1"},
        manifest_draft={"manifest_version": "projectmind/v1alpha1"},
        report={"report_version": "projectmind.skill-interpretation-report/v1"},
...
def _version_aggregate(
    ...
    *,
    ...
    manifest = SimpleNamespace(
        ...
        manifest_json={"manifest_version": "projectmind/v1alpha1"},
    )
