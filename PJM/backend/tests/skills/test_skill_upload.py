...
from projectmind.db.models import SkillSource
...
from projectmind.storage import InMemoryFileStorage
...
async def test_save_upload_stores_binary_bundle_and_text_only_snapshot() -> None:
    ...
    assert source.storage_uri.startswith("s3://projectmind/organizations/")
    ...
    prefix = source.storage_uri.removeprefix("s3://projectmind/")
