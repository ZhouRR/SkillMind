...
from projectmind.db.models import ProjectSkillVersion, RuntimeManifest, SkillSource, SkillVersion
...
async def prepare(
    ...
    Clock.current = NOW
    monkeypatch.setattr("projectmind.skills.service.datetime", Clock)
