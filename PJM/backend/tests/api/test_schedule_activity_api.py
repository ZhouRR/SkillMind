...
from projectmind.api.routes.schedules import ScheduleActivityResponse, _activity_response
...
from projectmind.schedules.repository_occurrences import _activity
