...
from projectmind.skills.domain import InlineSkillFile
from projectmind.skills.importer import NormalizedSkillPackage, SkillPackageParser
...
class SkillStaticAnalysis:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            "analysis_version": "projectmind.skill-static-analysis/v1",
            "source_hash": self.source_hash,
...
def load_interpreter_system_skill(
    ...
    *,
    ...
    if package.name != "projectmind-skill-interpreter":
...
def build_interpreter_request(
    *,
    ...
    return {
        ...
        "target_contracts": {
            "runtime_manifest": "projectmind/v1alpha1",
            "task_contract_draft": "projectmind.task-contract-draft/v1",
            "view_spec": "projectmind.view/v1alpha1",
            "response": "projectmind.skill-interpreter.response/v1",
        },
...
def load_capability_catalog(path: Path) -> CapabilityCatalogSnapshot:
    """Versioned JSON fixture から checksum 検証済み catalog snapshot を読む。"""
