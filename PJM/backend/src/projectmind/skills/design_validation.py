...
from projectmind.evaluations.domain import InvalidEvaluationRevisionError, resolve_json_pointer
from projectmind.skills.capability_blueprint import (
    CapabilityBlueprintError,
    CapabilityBlueprintValidator,
)
from projectmind.skills.importer import SkillImportLimits
...
def _validate(
    ...
    _require(manifest.get("manifest_version") == "projectmind/v1alpha1")
    expected_identity = {
