...
class JsonLogFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        payload: dict[str, Any] = {
            ...
            "logger": record.name,
            "event": getattr(record, "projectmind_event", record.getMessage()),
        }
        context = getattr(record, "projectmind_context", {})
...
def log_event(
    ...
    **context: object,
    ...
    logger.log(
        level,
        event,
        extra={"projectmind_event": event, "projectmind_context": safe_context},
    )
