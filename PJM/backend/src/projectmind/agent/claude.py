...
from projectmind.agent.tool_policy import DENIED_BUILTIN_TOOLS, ToolExecutionPolicy
...
def build_claude_agent_options(
    ...
    *,
        ...
        if tool_name in deferred_tool_names:
            ...
            return {
                "hookSpecificOutput": {
                    ...
                    "permissionDecisionReason": "ProjectMind requires a durable user interaction",
                }
            }
            ...
            if not isinstance(tool_use_id, str) or not isinstance(session_id, str):
                return {
                    "hookSpecificOutput": {
                        "hookEventName": "PreToolUse",
                        "permissionDecision": "deny",
                        "permissionDecisionReason": "Missing ProjectMind invocation identity",
                    }
                }
            try:
                ...
                return {
                    "hookSpecificOutput": {
                        "hookEventName": "PreToolUse",
                        "permissionDecision": "deny",
                        "permissionDecisionReason": "ProjectMind tool audit registration failed",
                    }
                }
        return {
            "hookSpecificOutput": {
                ...
                "permissionDecisionReason": "Registered ProjectMind read-only tool",
            }
        }
    ...
    return ClaudeAgentOptions(
        ...
        mcp_servers={"projectmind": mcp_server},
