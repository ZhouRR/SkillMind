...
from projectmind.artifacts.domain import MAX_RUN_ARTIFACT_BYTES, MAX_RUN_ARTIFACTS, ArtifactDraft
...
if TYPE_CHECKING:
    from projectmind.runs.tool_execution import ToolExecutionGate
        ...
        async with self._session_factory() as session, session.begin():
            ...
            session.add(
                PermissionDecision(
                    ...
                    decision="AUTO_ALLOW",
                    decided_by=None,
                    reason="Registered ProjectMind scoped tool",
