...
OUTCOME_ENVELOPE_VERSION = "projectmind.outcome-envelope/v1"
OUTCOME_ENVELOPE_SCHEMA_REF = (
    "https://schemas.projectmind.local/outcomes/envelope/v1.schema.json"
)
...
OUTCOME_ENVELOPE_SCHEMA: dict[str, Any] = {
    ...
    "title": "ProjectMind OutcomeEnvelope v1",
    "type": "object",
