...
_EFFECT_PROTOCOL = "projectmind.redmine-effect/v1"
_EFFECT_CAPABILITIES_PATH = "/.well-known/projectmind-effect-provider.json"
_ISSUE_UPDATE_PATH = "/projectmind/effects/issue.update/v1/issues"
    ...
    def _request_json(
        ...
        *,
        ...
        if idempotency_key is not None:
            headers["X-ProjectMind-Idempotency-Key"] = idempotency_key
