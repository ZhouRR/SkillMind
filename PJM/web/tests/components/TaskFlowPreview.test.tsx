...
describe('read-only original task flow rendering', () => {
  ...
  it.each(['zh', 'ja', 'en'] as UiLanguage[])('shows original numeric tokens, not wrapper metadata or rounded JSON in %s', (language) => {
    const contract = '{"contract_version":"projectmind.task-contract-draft/v1","type":"number","minimum":-9007199254740993,"maximum":1e100,"enum":[9007199254740992,9007199254740993,1.0,1e-7,-0]}'
