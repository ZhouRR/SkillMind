...
export function ResultValidationScope({ result }: { result: RunResultDetail }) {
  ...
  return <section className="resultSection resultValidationScope" aria-label={labels.title}>
    ...
    {recorded ? <>
      ...
      <ul>
        ...
        <li>{checks.version === 'projectmind.result-reference-checks/v2' ? labels.artifactsVerified : labels.artifacts}</li>
      </ul>
