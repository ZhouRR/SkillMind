...
| 使用者 | 主要工作 | 入口 |
| --- | --- | --- |
| 管理员 ADMIN | 管理组织 Skill、精确版本、项目与资源配置 | 技能库、项目管理、资源管理；成员管理已有 API/client，尚无页面入口 |
...
项目用于隔离资源和执行，不是系统角色。[归档的具体例子](../design/project-lifecycle.md#一个例子归档不是停止或删除)说明停止、成员移除、归档和删除的区别；归档不是“一键停止并清空”。
